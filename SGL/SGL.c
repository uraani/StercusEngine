...
static void demo_prepare_buffers(SGL_VkContext* vkContext) {
	...
	vkContext->buffers = (SwapchainBuffers *)malloc(sizeof(SwapchainBuffers) *
		vkContext->swapchainImageCount);
...
void demo_prepare_cube_data_buffer(SGL_VkContext* vkContext) {
	...
	/*projection[0][0] = vkContext->projection_matrix.m00;
	projection[0][1] = vkContext->projection_matrix.m01;
	projection[0][2] = vkContext->projection_matrix.m02;
	projection[0][3] = vkContext->projection_matrix.m03;
	projection[1][0] = vkContext->projection_matrix.m10;
	projection[1][1] = vkContext->projection_matrix.m11;
	projection[1][2] = vkContext->projection_matrix.m12;
	projection[1][3] = vkContext->projection_matrix.m13;
	projection[2][0] = vkContext->projection_matrix.m20;
	projection[2][1] = vkContext->projection_matrix.m21;
	projection[2][2] = vkContext->projection_matrix.m22;
	projection[2][3] = vkContext->projection_matrix.m23;
	projection[3][0] = vkContext->projection_matrix.m30;
	projection[3][1] = vkContext->projection_matrix.m31;
	projection[3][2] = vkContext->projection_matrix.m32;
	projection[3][3] = vkContext->projection_matrix.m33;

	view[0][0] = vkContext->view_matrix.m00;
	view[0][1] = vkContext->view_matrix.m01;
	view[0][2] = vkContext->view_matrix.m02;
	view[0][3] = vkContext->view_matrix.m03;
	view[1][0] = vkContext->view_matrix.m10;
	view[1][1] = vkContext->view_matrix.m11;
	view[1][2] = vkContext->view_matrix.m12;
	view[1][3] = vkContext->view_matrix.m13;
	view[2][0] = vkContext->view_matrix.m20;
	view[2][1] = vkContext->view_matrix.m21;
	view[2][2] = vkContext->view_matrix.m22;
	view[2][3] = vkContext->view_matrix.m23;
	view[3][0] = vkContext->view_matrix.m30;
	view[3][1] = vkContext->view_matrix.m31;
	view[3][2] = vkContext->view_matrix.m32;
	view[3][3] = vkContext->view_matrix.m33;*/

	VP = SM_M4Multiply(&vkContext->view_matrix, &vkContext->projection_matrix);
	//mat4x4_mul(vp0, projection, view);
...
void SGL_Vk_CreateContext(SGL_Window* window)
{
	...
	window->vkContext.device_validation_layers[0] = "VK_LAYER_LUNARG_threading";
