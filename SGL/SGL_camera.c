...
//#include "SDL.h"
SGL_Camera* SGL_CreateCamera(SGL_GLContext* rContext, const unsigned int type, const unsigned int id, const float nearPlane, const float farPlane, const float FOWY, const float scale)
{
...
SGL_UpdateCameras(SGL_GLContext* rContext)
{
	unsigned int i;
