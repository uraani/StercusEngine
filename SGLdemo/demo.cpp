...
#define SPRITE_COUNT_STRING "1000000"
	...
	SGL_Camera* camera0 = SGL_CreateCamera(SGL_CAMERA_TYPE_ORTHO, SGL_CAMERA_ORTHO, 0.1f, 2.0f, degreesToRadians(45.0f), 1.0f, &window.rContext);
...
//	float rotation = 0.0f;
	...
	glTexStorage2D(GL_TEXTURE_2D, 1, GL_RGBA8, window.rContext.lightMapSize, window.rContext.lightMapSize);
